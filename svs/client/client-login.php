...
<head>
    ...
    <div class="split-screen-container">
        <div class="image-section">
            ...
            <img src="../images/auth_client.jpg" alt="Luxury hair treatment" class="hero-image">
        </div>

        <div class="form-section">
            <div class="form-wrapper">
                <h1 class="serif-title">Log In Form</h1>
                ...
                <div class="footer-links">
                    <p class="account-link">Don’t have An Account? <a href="client-signup.php">Sign Up Here.</a></p>
                    <p class="pro-link serif-title">Are you a Professional but don’t have an account? <a href="../professional/pro-signup.php">Sign Up Here.</a></p>
                </div>
            </div>
        </div>
    </div>
