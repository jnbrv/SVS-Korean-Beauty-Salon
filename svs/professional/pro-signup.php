...
<head>
    ...
    <title>Salon - Stylist Partner Sign Up</title>
    ...
    <div class="split-screen-container">
        <div class="image-section">
            ...
            <img src="../images/auth-pro.jpg" alt="Luxury styling station" class="hero-image">
        </div>

        <div class="form-section">
            <div class="form-wrapper">
                <h1 class="serif-title">Sign Up For Professional</h1>
                <p class="subtitle">Join our professional network</p>

                <form action="process-pro-signup.php" method="POST">
                    <div class="input-group">
                        <input type="text" placeholder="Full Name" required>
                    </div>
                    <div class="input-group">
                        <input type="tel" placeholder="Cell Phone Number" required>
                    </div>
                    <div class="input-group">
                        <input type="email" placeholder="Business Email Address" required>
                    </div>
                    <div class="input-group">
                        <input type="text" placeholder="License / Certification Number (Optional)">
                    </div>
                    ...
                    <button type="submit" class="primary-btn">Create Professional Account</button>
                </form>

                <div class="footer-links">
                    <p class="account-link">Already have an account? <a href="pro-login.php">Log In Here.</a></p>
                    <p class="pro-link serif-title">Are you a Client? <a href="../client/client-login.php">Log In here.</a></p>
                </div>
            </div>
        </div>
    </div>
